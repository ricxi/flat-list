...
type MailerClient interface {
	SendActivationEmail(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *mailerClient) SendActivationEmail(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
type MailerServer interface {
	SendActivationEmail(context.Context, *Request) (*Response, error)
...
func (UnimplementedMailerServer) SendActivationEmail(context.Context, *Request) (*Response, error) {
...
func _Mailer_SendActivationEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MailerServer).SendActivationEmail(ctx, req.(*Request))
	}
